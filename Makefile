...
drop_database:
	dropdb --if-exists ${database_name} -h gias-db.cluster-cuextdorzrgu.eu-west-2.rds.amazonaws.com -U postgres ${database_name}

create_database:
	createdb ${database_name} -h gias-db.cluster-cuextdorzrgu.eu-west-2.rds.amazonaws.com -U postgres
